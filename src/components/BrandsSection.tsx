...
const HP_CATEGORIES = [
  {
    ...
    shortName: "EliteBook",
    description:
      "Premium enterprise laptops designed for executive durability and performance.",
    accentColor: "sky",
    badgeClass:
  ...
  },
  {
    ...
    shortName: "ProBook",
    description:
      "Versatile, robust business laptops engineered for security and daily productivity.",
    accentColor: "blue",
    badgeClass:
  ...
  },
  {
    ...
    shortName: "ZBook",
    description:
      "High-performance mobile workstations built for heavy computing and graphics.",
    accentColor: "indigo",
    badgeClass:
...
export default function BrandsSection() {
  ...
  const currentCategoryModels =
    selectedBrand && selectedCategory
      ? selectedBrand.models.filter(
          (m) =>
            m.category?.toLowerCase() ===
              selectedCategory.toLowerCase() ||
            m.series?.toLowerCase() === selectedCategory.toLowerCase()
        )
      : [];
            ...
            >
              <div className="flex flex-col items-start gap-2">
                ...
                <p className="text-sm sm:text-base text-slate-400 max-w-2xl">
                  Select a manufacturer below to browse compatible systems,
                  authorized parts, and dedicated model catalogs.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-6">
                <div>
                  ...
                  <p className="text-sm sm:text-base text-slate-400 mt-1">
                    Select a family category below to explore verified HP
                    laptop models and technical specifications.
                  </p>
                </div>
                ...
                {HP_CATEGORIES.map((cat, idx) => {
                  const count = selectedBrand.models.filter(
                    (m) =>
                      m.category?.toLowerCase() ===
                        cat.id.toLowerCase() ||
                      m.series?.toLowerCase() === cat.id.toLowerCase()
                  ).length;
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-6">
                <div>
                  ...
                  <p className="text-sm sm:text-base text-slate-400 mt-1">
                    Select a model below to view full specifications and
                    product details.
                  </p>
                </div>
            ...
            >
              ...
              >
                ...
                <p className="text-sm text-slate-400 max-w-md">
                  The {selectedBrand.name} model lineup structure with{" "}
                  {selectedBrand.models.length} laptop models is ready in the
                  catalog matrix.
                </p>
                ...
                <div className="flex flex-wrap items-center justify-center gap-3 mt-2">
                  ...
                  >
                    <span>
                      View {selectedBrand.models.length}{" "}
                      {selectedBrand.name} Laptops
                    </span>
